...
**Slot:** Member 3 (240285P · Jayasuriya D.G.N.C) · **Migration block (Phase 1):** `0140–0159`
**Branch prefix:** `feat/pPP-m03-<slug>`
...
| **Routines** | `sp_open_savings_account`, `sp_close_account`, `fn_check_plan_eligibility`, `fn_check_plan_minimum`, `fn_next_account_number`, `trg_validate_joint_mandate` |
| **Backend** | `/api/plans`, `/api/accounts`, `/api/accounts/{id}/holders`, `/api/accounts/{id}/close` |
| **Frontend** | Plan administration, account opening wizard, account detail, joint holder and mandate management |
| **Report** | **RPT-02 — Account-wise transaction summary** |

**Files you own:** `app/plans/**`, `app/accounts/**`, `app/reports/account-summary/**`
...
```
You are helping Member 3 on the MIMS project (CS3043 Database Systems, Group 32).
My slice is: Accounts, Plans & Joint Ownership.
